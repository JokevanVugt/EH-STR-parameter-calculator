...
- `AlleleDepth` calculates the read depth of each allele using the number of spanning, flanking and inrepeat reads that is evidence for the allele and considering whether the genotype is homozygous, heterozygous or haploid.
- `Missing` 
- `OffDepth`
- `OffCI`
- `FLL`
